...
Use the query parameter `family` to configure which metric families you want to collect. For example: `/metrics/7s_streams?family=stream_metrics&family=consumers`. 
